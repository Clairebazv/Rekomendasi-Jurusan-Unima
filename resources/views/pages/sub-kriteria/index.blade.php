  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Daftar Sub Kriteria</div>
      </div>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        <div class="card-header">
          <button id="showAddModalBtn" type="button" class="btn btn-light">
      ...
      <div class="modal-content">
        <form id="newDataForm">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Tambah Sub Kriteria</h5>
          </div>
          <div class="modal-body">
            <div class="form-group">
              <label>Kriteria</label>
              <select name="kriteria_id" class="custom-select" required>
...
@push('scripts')
  <script>
    $(function () {
      ...
      // /*------------------------------------------ Show modal button add new sub kriteria --------------------------------------------*/ 
      ...
      $('#newDataForm').submit(function (e) {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            Swal.fire({
              title: 'Berhasil',
              text: 'Sub Kriteria berhasil disimpan',
              icon: 'success',
      ...
      // /*------------------------------------------ Show modal button edit sub kriteria --------------------------------------------*/
      ...
      $('#editDataForm').submit(function (e) {
        ...
        let url = '{{ route('sub-kriteria.update', ':id') }}'; url = url.replace(':id', dataId);
      ...
      // /*------------------------------------------ Show modal delete sub kriteria --------------------------------------------*/ 
      $(document).on('click', '.show-delete-modal', function () {
        $('#deleteDataModal').modal('show');
        $('#deleteDataId').val($(this).data("id"));
      });

      // /*------------------------------------------ Delete data sub kriteria --------------------------------------------*/ 
      $('#confirmDeleteBtn').click(function (e) {
        $(this).html('Menghapus...');

        let dataId = $('#deleteDataId').val();
        let url = '{{ route('sub-kriteria.destroy', ':id') }}'; url = url.replace(':id', dataId);
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            Swal.fire({
              title: 'Berhasil',
              text: 'Sub Kriteria berhasil dihapus',
              icon: 'success',
              confirmButtonText: 'OK'
            })
          },
